...
public class WebTTSWS {
    ...
    private static final String appid = "5e250ac9";//到控制台-语音合成页面获取
    private static final String apiSecret = "64692d731a19afb8d60a8a2a5b9d30a2";//到控制台-语音合成页面获取
    private static final String apiKey = "e8fdd3e01362cb0b1ae5c17301006ae3";//到控制台-语音合成页面获取
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebSocket webSocket = client.newWebSocket(request, new WebSocketListener() {
            ...
            public void onOpen(WebSocket webSocket, Response response) {
                ...
                try {
                    data.addProperty("text", Base64.getEncoder().encodeToString(args[1].getBytes("utf8")));
