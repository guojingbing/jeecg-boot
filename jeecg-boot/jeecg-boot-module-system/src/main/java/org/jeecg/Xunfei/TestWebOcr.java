...
public class TestWebOcr {
	...
	private static final String TEST_APPID = "5e250ac9";
	// 接口密钥(webapi类型应用开通手写文字识别后，控制台--我的应用---手写文字识别---相应服务的apikey)
	private static final String TEST_API_KEY = "6c7a774df498ec32e4339752e99e1622";
	// 测试图片文件存放位置
	private static final String IMAGE_FILE_PATH = "E://1.jpeg";
